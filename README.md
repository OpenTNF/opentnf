...
The first release of the specification is available for download <a href="https://github.com/OpenTNF/opentnf/releases/download/0.94/OpenTNF.-.white.paper.pdf" target="_blank">OpenTNF 0.94 <img src="https://github.com/OpenTNF/opentnf/blob/master/pdf_icon.png" tag="pdf"></a>
